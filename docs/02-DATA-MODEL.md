...
> **Phase-0 rule:** the _entire_ v1 schema below is written and migrated in Phase 0
...
surface as an _error_, never as "price changed to nothing" firing a false alert.
...
research on competitor-price tooling is consistent: users want _immediate_ alerts
for meaningful moves (">5% drop"), a _daily digest_ for small ones, and silence
