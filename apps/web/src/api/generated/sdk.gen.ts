 ...
 */
export const listLogs = <ThrowOnError extends boolean = false>(options?: Options<ListLogsData, ThrowOnError>): RequestResult<ListLogsResponses, ListLogsErrors, ThrowOnError> => (options?.client ?? client).get<ListLogsResponses, ListLogsErrors, ThrowOnError>({ url: '/admin/logs', ...options });

/**
 * System counts and queue depths
 */
export const getAdminStats = <ThrowOnError extends boolean = false>(options?: Options<GetAdminStatsData, ThrowOnError>): RequestResult<GetAdminStatsResponses, GetAdminStatsErrors, ThrowOnError> => (options?.client ?? client).get<GetAdminStatsResponses, GetAdminStatsErrors, ThrowOnError>({ url: '/admin/stats', ...options });
 ...
 */
export const exportMonitor = <ThrowOnError extends boolean = false>(options: Options<ExportMonitorData, ThrowOnError>): RequestResult<ExportMonitorResponses, ExportMonitorErrors, ThrowOnError> => (options.client ?? client).get<ExportMonitorResponses, ExportMonitorErrors, ThrowOnError>({ url: '/monitors/{monitorId}/export', ...options });
 ...
 */
export const getMonitorSeries = <ThrowOnError extends boolean = false>(options: Options<GetMonitorSeriesData, ThrowOnError>): RequestResult<GetMonitorSeriesResponses, GetMonitorSeriesErrors, ThrowOnError> => (options.client ?? client).get<GetMonitorSeriesResponses, GetMonitorSeriesErrors, ThrowOnError>({ url: '/monitors/{monitorId}/series', ...options });

/**
 * Import monitors from exported configurations
 */
export const importMonitors = <ThrowOnError extends boolean = false>(options: Options<ImportMonitorsData, ThrowOnError>): RequestResult<ImportMonitorsResponses, ImportMonitorsErrors, ThrowOnError> => (options.client ?? client).post<ImportMonitorsResponses, ImportMonitorsErrors, ThrowOnError>({
    url: '/monitors/import',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const previewRule = <ThrowOnError extends boolean = false>(options: Options<PreviewRuleData, ThrowOnError>): RequestResult<PreviewRuleResponses, PreviewRuleErrors, ThrowOnError> => (options.client ?? client).post<PreviewRuleResponses, PreviewRuleErrors, ThrowOnError>({ url: '/rules/{ruleId}/preview', ...options });
