...
/**
 * Recent application logs from both services
 */
...
/**
 * System counts and queue depths
 */
export const getAdminStatsOptions = (options?: Options<GetAdminStatsData>) => queryOptions<GetAdminStatsResponse, GetAdminStatsError, GetAdminStatsResponse, ReturnType<typeof getAdminStatsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
